...
def main(args):                                                                         #this is the main method
    ...
    while not rospy.is_shutdown():
        ...
        ur5_pose_1.position.x = 0.16 + trans.transform.translation.x + 0.1
        ur5_pose_1.position.y = 0 + trans.transform.translation.y - 0.25
        ur5_pose_1.position.z = 0.53 + trans.transform.translation.z + 0.02
        ...
        ur5_pose_1.position.x = 0.16 + trans1.transform.translation.x + 0.16
        ur5_pose_1.position.y = 0 + trans1.transform.translation.y - 0.4
        ur5_pose_1.position.z = 0.53 + trans1.transform.translation.z 
        ...
        ur5_pose_1.position.x = 0.16 + trans1.transform.translation.x + 0.1
        ur5_pose_1.position.y = 0 + trans1.transform.translation.y - 0.25
        ur5_pose_1.position.z = 0.53 + trans1.transform.translation.z + 0.02
